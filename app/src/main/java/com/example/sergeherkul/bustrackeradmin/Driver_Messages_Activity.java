...
import com.example.sergeherkul.bustrackeradmin.Adapters.MessagesAdapter;
import com.example.sergeherkul.bustrackeradmin.Model.Messages;
...
public class Driver_Messages_Activity extends AppCompatActivity {
    ...
    private String school_id, driver_code, messages_title, messages_message, messages_time,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages_accessor = new Accessories(Driver_Messages_Activity.this);

        mauth = FirebaseAuth.getInstance();

        school_id = messages_accessor.getString("school_code");
        driver_code = messages_accessor.getString("driver_code");
        ...
        messages_Adapter = new MessagesAdapter(getmessagesFromDatabase(), Driver_Messages_Activity.this);
        messages_RecyclerView.setAdapter(messages_Adapter);
    }

    private void getUsermessages_ID() {
        try{
            DatabaseReference get_Driver_messages = FirebaseDatabase.getInstance().getReference("messages").child(school_id).child(driver_code);
...
//                    Toast.makeText(getActivity(),"Cannot get ID",Toast.LENGTH_LONG).show();
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(Driver_Messages_Activity.this,"Cancelled",Toast.LENGTH_LONG).show();
                }
            });
    ...
    private void Fetch_User_messages(String key) {
        DatabaseReference getmessages = FirebaseDatabase.getInstance().getReference("messages").child(school_id).child(driver_code).child(key);
